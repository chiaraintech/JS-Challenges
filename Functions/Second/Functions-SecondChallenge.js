...
//The callback function within the event listener works because of the closure.
//The closure here is useful because by the time this callback is executed, the IIFE is now gone (and with it, the header variable is gone, too).
//The function is however attached to the body element, awaiting execution orders.